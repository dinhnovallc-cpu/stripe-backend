      ...
      return {
        price_data: {
          ...
          product_data: {
            ...
            metadata: {
              shopify_variant_id: String(item.variant_id || item.variantId || item.id || ""),
              shopify_product_id: String(item.product_id || item.productId || ""),
              original_price: String(item.original_price || item.compare_at_price || ""),
